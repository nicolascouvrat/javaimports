...
""";
  ...
  void itShouldParseDependenciesForWorkspaceWithPin() throws Exception {
    var raw =
        """
1 @maven//:com_google_guava_guava
2 @maven//:com/google/guava/guava/33.3.0-jre/guava-33.3.0-jre.jar
2 @maven//:com_google_guava_failureaccess
3 @maven//:com_google_guava_guava_33_3_0_jre_extension
3 @maven//:com/google/guava/failureaccess/1.0.2/failureaccess-1.0.2.jar
5 @com_google_guava_guava_33_3_0_jre//file:v1/com/google/guava/guava/33.3.0-jre/guava-33.3.0-jre.jar
6 @com_google_guava_failureaccess_1_0_2//file:v1/com/google/guava/failureaccess/1.0.2/failureaccess-1.0.2.jar
""";
    ...
    assertThat(got.deps())
        .containsExactly(
            direct(
                "/output/base/external/com_google_guava_guava_33_3_0_jre/file/v1/com/google/guava/guava/33.3.0-jre/guava-33.3.0-jre.jar"),
            transitive(
