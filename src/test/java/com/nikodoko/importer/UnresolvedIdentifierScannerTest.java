...
public class UnresolvedIdentifierScannerTest {
  ...
  public static Collection<Object[]> parameters() {
    String[][][] inputOutputs = {
      ...
      //     "  }",
      //     "",
      //     "  public static <E> ImmutableSet<E> of(E e1, E e2, E e3, E e4, E e5, E e6, E...
      // others) {",
      //     "    checkArgument(",
      //     "        others.length <= Integer.MAX_VALUE - 6, \"the total number of elements must
      // fit in an int\");",
      ...
      //     "        break;",
      //     "      }",
      //     "      if (endOfStartRun + (hashTable.length - 1 - startOfEndRun) >
